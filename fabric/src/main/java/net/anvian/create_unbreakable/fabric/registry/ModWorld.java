...
public class ModWorld {
    private static final ResourceKey<PlacedFeature> LUMINARCHY_ORE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(CreateUnbreakableToolsMod.MOD_ID, "luminarchy_ore"));
    private static final ResourceKey<PlacedFeature> PHILOLITE_ORE_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(CreateUnbreakableToolsMod.MOD_ID, "philolite_ore"));
